    ...
    return function t(e, n, r) {
        ...
        16: [function(t, e, n) {
            ...
            e.exports = function(e, n, r, i, o, s) {
                ...
                p.inherits(c, o), c.prototype._isResolved = function() {
                    ...
                    if (!this._isResolved()) {
                        var t;
                        if (void 0 !== this._generator.return) this._promise._pushContext(), t = f(this._generator.return).call(this._generator, void 0), this._promise._popContext();
                        else {
                            var n = new e.CancellationError("generator .return() sentinel");
                            e.coroutine.returnSentinel = n, this._promise._attachExtraTrace(n), this._promise._pushContext(), t = f(this._generator.throw).call(this._generator, n), this._promise._popContext()
                        }
            ...
            e.exports = function() {
                ...
                return i.prototype.toString = function() {
                    ...
                    if (0 == (65536 & i)) {
                        ...
                        var s = r._popContext();
                        0 == (65536 & (i = r._bitField)) && (o === C ? r._reject(n) : o === S ? r._rejectCallback(o.e, !1) : (x.checkForgottenReturns(o, s, "", r, this), r._resolveCallback(o)))
                    }
        ...
        24: [function(t, e, n) {
            ...
            e.exports = function(e, n) {
                ...
                function a(t, e, n, r) {
                    for (var a = h.inheritedDataKeys(t), c = [], l = 0; l < a.length; ++l) {
                        var u = a[l],
                            p = t[u],
                            f = r === w || w(u, p, t);
                        "function" != typeof p || i(p) || o(t, u, e) || !r(u, p, t, f) || c.push(u, p)
                    }
                    return s(c, e, n), c
                }
                ...
                function l(t, e, n, r, i) {
                    for (var o = new RegExp(C(e) + "$"), s = a(t, e, o, n), c = 0, l = s.length; l > c; c += 2) {
                        var u = s[c],
                            f = s[c + 1],
                            _ = u + e;
                        if (r === j) t[_] = j(u, p, u, f, e, i);
                        else {
                            var d = r(f, function() {
                                return j(u, p, u, f, e, i)
                            });
                ...
                var p = {},
                    ...
                    m = ["arity", "length", "name", "arguments", "caller", "callee", "prototype", "__isPromisified__"],
                    b = new RegExp("^(?:" + m.join("|") + ")$"),
                    w = function(t) {
                ...
                e.promisify = function(t, e) {
                    ...
                    var o = e.promisifier;
                    if ("function" != typeof o && (o = j), !h.isIdentifier(r)) throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/MqrFmX\n");
        ...
        28: [function(t, e, n) {
            ...
            e.exports = function(e, n, r, i, o, s) {
                function a(t, n, r, i) {
                    this.constructor$(t);
                    var s = h();
                    this._fn = null === s ? n : f.domainBind(s, n), void 0 !== r && (r = e.resolve(r), r._attachCancellationCallback(this)), this._initialValue = r, this._currentCancellable = null, this._eachValues = i === o ? Array(this._length) : 0 === i ? null : void 0, this._promise._captureStackTrace(), this._init$(void 0, -5)
                }
        ...
        36: [function(t, e, n) {
            ...
            var N = "undefined" != typeof process && "[object process]" === w(process).toLowerCase(),
                H = "undefined" != typeof process && void 0 !== process.env,
                B = {
                    isClass: h,
                    isIdentifier: _,
                    inheritedDataKeys: O,
    ...
    function(t) {
        window.NggPaginatedGallery = function(e, n) {
            this.displayed_gallery_id = e, this.container = t(n), this.container_name = n, this.get_displayed_gallery_obj = function() {
                ...
                return void 0 !== window.galleries[t] && window.galleries[t]
            }, this.enable_ajax_pagination = function() {
                var e = this;
                t("body").on("click", "a.ngg-browser-prev, a.ngg-browser-next", function(r) {
                    var i = !0;
                    t(this).parents(n).each(function() {
                        if (t(this).data("nextgen-gallery-id") != e.displayed_gallery_id) return !0;
                        i = !1
            ...
            r && void 0 !== r.display_settings.ajax_pagination && parseInt(r.display_settings.ajax_pagination) && this.enable_ajax_pagination(), void 0 === window.ngg_ajax_operation_count && (window.ngg_ajax_operaton_count = 0)
        }
    }(jQuery);